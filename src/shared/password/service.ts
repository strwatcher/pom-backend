...
type GeneratePasswordHashParams = Pick<
  GeneratePasswordHashFullParams,
  "password"
>;
...
export type PasswordService = {
  generatePasswordHash: RTE.ReaderTaskEither<
...
export const setupPasswordService: SetupPasswordService = ({
  hash,
  verify,
}) => ({
